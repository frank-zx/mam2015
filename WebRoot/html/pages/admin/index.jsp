...
<body>
	...
	<div class="main">
		<form id="js-msg-sub" action="admin/addNews.action" method="post">
			<div class="form-title">

				<h4>> 发布消息</h4>
			</div>
			<div class="form-group" method="post">
				<label for="art-title" class="control-label">消息标题：</label> <input
					type="text" name="title" class="form-control" id="js-title" placeholder="输入消息标题"
					>
			</div>
			<div class="form-group">
				<label for="art-content">消息内容：</label>
