...
<title>已提交论文列表-第十届（2015）中国管理学年会</title>
	 ...
	 <div class="main-content">
      ...
      <div class="content-article">
        ...
        <div class="content-con">
          <div class="news-list">
                    <h4 class="title-bar">
                        <span class="topic-name">论文标题</span>
                        <span class="post-time">发布时间</span>
                        <span class="views">审核状态</span>
                    </h4>
                    <ul>
                   <c:forEach items="${paperList}" var="paper">
                    	<li>
                            ...
                            <span class="post-time"><fmt:formatDate
										value="${paper.createDatetime}" type="date" /></span>
                           
                             <span class="downloads">${paper.checkStatus}</span>
                        </li>
                       </c:forEach>
                    </ul>
          </div>
